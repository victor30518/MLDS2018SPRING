...
def restore():
	...
	np.save('./interpolation/train_loss_2.npy', np.array(loss_list))
	np.save('./interpolation/val_loss_2.npy', np.array(loss_list2))
	np.save('./interpolation/train_acc_2.npy', np.array(acc_list))
	np.save('./interpolation/val_acc_2.npy', np.array(acc_list2))
	sess.close()
